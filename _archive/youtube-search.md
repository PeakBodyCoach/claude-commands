...
Example invocations:
- `/youtube-search lofi hip hop` → search for "lofi hip hop", 5 results
- `/youtube-search -n 10 python tutorial` → search for "python tutorial", 10 results
- `/youtube-search --json cats` → output raw JSON for "cats"
